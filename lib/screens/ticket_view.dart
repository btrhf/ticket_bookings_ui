...
import 'package:ticket_bookings/widgets/thick_container.dart';
          ...
          children: [
            ...
            Container(
              decoration: BoxDecoration(
                ...
                padding: EdgeInsets.only(left: AppLayout.getWidth(16), top: AppLayout.getHeight(12), right: AppLayout.getWidth(16), bottom: AppLayout.getHeight(16)),
              child: Column(
                children: [
                  Row(
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
